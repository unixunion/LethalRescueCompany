    ...
    internal class PlayerControllerBPatch : BaseUnityPlugin
    {
                                ...
                                ref DeadBodyInfo ___deadBody)
        {
            try
            {
                ...
                if (___deadBody.gameObject.GetComponentInChildren<SkinnedMeshRenderer>().sharedMaterial.name == "SpooledPlayerMat" && !___deadBody.grabBodyObject.grabbable && ___deadBody.attachedTo.name != "MouthTarget")
                {
